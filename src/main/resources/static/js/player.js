...
var wp = document.getElementById('whole-player');
...
Player.prototype = {
  ...
  /**
   * Exchange playlist method, make request for new playlist first!
   * @param newPlaylist New playlist variable
   */

  switchPlaylist: function (newPlaylist) {
  ...
  /**
   * Unloads player, deletes everything from cache.
   */
